      ...
      <div className="p-6 relative z-10">
          ...
          <div className="container mx-auto max-w-7xl">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <div className="mr-5 bg-gradient-to-br from-blue-500 to-green-600 p-4 rounded-xl shadow-lg">
                  <Filter size={36} className="text-white" />
                </div>
                <div>
                  <h1 className="text-4xl font-bold text-gray-800">Production Analysis</h1>
                  <p className="text-blue-600 mt-2">Filter and visualize production metrics</p>
                </div>
              </div>
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          {!loading && filteredData.length > 0 && (
            <div className="backdrop-blur-md bg-white/80 p-6 rounded-xl shadow-lg border border-gray-200 mb-8">
              <ProductionStats filteredData={filteredData} />
            </div>
          )}

          {/* Production Charts (Monthly/Daily) */}
          {!loading && filteredData.length > 0 && (
            <div className="backdrop-blur-md bg-white/80 p-6 rounded-xl shadow-lg border border-gray-200 mb-8">
              <ProductionCharts filteredData={filteredData} />
            </div>
          )}
          
          {/* Machine Production Chart (Top/Bottom 5) */}
          {!loading && filteredData.length > 0 && (
            <div className="backdrop-blur-md bg-white/80 p-6 rounded-xl shadow-lg border border-gray-200 mb-8">
              <MachineProductionChart filteredData={filteredData} />
            </div>
          )}
