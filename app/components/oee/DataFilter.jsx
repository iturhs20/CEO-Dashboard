...
import OEEBarGraph from './OEEBarGraph';
          ...
          <div className="container mx-auto max-w-7xl">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div>
                  <h1 className="text-4xl font-bold text-gray-800">OEE Analysis</h1>
                  <p className="text-blue-600 mt-2">Filter and visualize operational efficiency metrics</p>
                </div>
              </div>
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="backdrop-blur-md bg-white/80 p-6 rounded-xl shadow-lg border border-gray-200 mb-8">
            {loading ? (
              ...
              <OEEBarGraph filteredData={filteredData} />
            ) : (
              <div className="flex flex-col justify-center items-center h-64">
          ...
          {!loading && filteredData.length > 0 && (
            <div className="backdrop-blur-md bg-white/80 p-6 rounded-xl shadow-lg border border-gray-200 mb-8">
              <MachinePerformanceChart filteredData={filteredData} />
            </div>
          )}
